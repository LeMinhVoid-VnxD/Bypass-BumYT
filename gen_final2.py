...
# Build bat file manually to avoid f-string % issues
bat_lines = []
bat_lines.append('@echo off')
bat_lines.append('chcp 65001 >nul')
bat_lines.append('title BumYT Bypass FINAL')
bat_lines.append('echo ============================================')
bat_lines.append('echo   BumYT Bypass FINAL')
bat_lines.append('echo   Remove obfuscation, remove key check')
bat_lines.append('echo ============================================')
bat_lines.append('echo.')
bat_lines.append('')
bat_lines.append('set "T=%~dp0BumYT\\_internal\\key_verify.py"')
bat_lines.append('if not exist "%T%" (')
bat_lines.append('    echo ERROR: Khong tim thay %T%')
bat_lines.append('    pause & exit /b 1')
bat_lines.append(')')
bat_lines.append('')
bat_lines.append('echo [*] Ghi bypass...')
bat_lines.append('powershell -NoProfile -ExecutionPolicy Bypass -Command "' +
    '[System.IO.File]::WriteAllBytes(\'' + '%T%' + '\', [System.Convert]::FromBase64String(\'' + b64 + '\'))"')
bat_lines.append('if %errorlevel% equ 0 (')
bat_lines.append('    echo [*] THANH CONG!')
bat_lines.append('    echo [*] KEY NHAP BAT KY DEU DUNG DUOC')
bat_lines.append(') else (')
bat_lines.append('    echo [*] THAT BAI!')
bat_lines.append(')')
...
print("Done! Run bypass_final.bat")
print(f"Bat line 17 length: {len(bat_lines[16])}")
